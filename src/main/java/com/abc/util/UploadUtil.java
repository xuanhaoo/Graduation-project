...
public class UploadUtil {
     ...
     * 腾讯云对象储存参数配置
     */
    private final static String secretId = "AKIDScdcPzHpx0bw1pIe3mEPIuFPIFxQptsi";
    private final static String secretKey = "A5KXcZLxQcOp32tZdcSAnJSSPCwTnttH";
    private final static String bucketName = "sharepug-1253924986";
    private final static String AppId = "1253924986";
